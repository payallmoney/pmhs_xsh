CREATE TABLE [dbo].[ChildrenStandardWeight]
(
...
GO
ALTER TABLE [dbo].[ChildrenStandardWeight] ADD CONSTRAINT [PK_ChildrenStandardWeight] PRIMARY KEY CLUSTERED  ([ID]) ON [PRIMARY]
GO
