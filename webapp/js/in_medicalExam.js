...
var cfg = [
		...
		},
		{
			...
			valFormula : $F('general09').div(
					$F('general08').multi($F('general08')).div($F(10000)))
		},
		{
			id : "general12",
			xtype : "input",
		...
		},
		{
			...
			xtype : "grid",
			setting : {
				displayCols : [ 'type', 'beginDate', 'endDate', 'reason',
						'hospital', 'reportNo' ],
				displayColNames : [ "住院类型", "入院/建床日期", "出院/撤床日期", "原因",
						"医疗机构名称", "病案号" ],
				colXtypes : [ 'list', 'input', 'input', 'input', 'input',
						'input' ],
				colSettings : [ {
					ds : "187",
					newLineStep : '1'
		...
		},
		{
			...
			xtype : "grid",
			setting : {
				displayCols : [ 'drugName', 'usageWay', 'dosage', 'drugTime',
						'dependency' ],
			...
			requires : [ {
				valEq : 5,
				fields : [ 'dangerControlOther1' ]
			}, {
				valEq : 6,
				fields : [ 'dangerControlOther2' ]
			}, {
				valEq : 7,
				fields : [ 'dangerControlOther3' ]
			} ]
		}, {
