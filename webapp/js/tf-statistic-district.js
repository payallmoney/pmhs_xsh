...
//			}
	...
	getParams : function(){
		...
		var rules = statisticMe ? '0' : (statisticAll ? '1' : (statisticLower ? '2' : '0'));
...
//			colsVisibleFalse.push(Utils.getColumnsIndexDetail(this.gridId,'flag'));
			if(healthfile){
				...
				colsVisibleFalse.push(Utils.getColumnsIndexDetail(this.gridId,'healthFileCount'));
				...
				colsVisibleTrue.push(Utils.getColumnsIndexDetail(this.gridId,'healthFileCount'));
...
//								  Ext.getCmp('statisticLowerAll').setValue(false);
						  ...
						  }),createCheckBox('显示所有数据',false,'statisticAll','statisticAll',0,25,3,function(obj,ischecked){
							  if(ischecked){
								  Ext.getCmp('statisticMe').setValue(false);
								  Ext.getCmp('statisticLower').setValue(false);
//								  Ext.getCmp('statisticLowerAll').setValue(false);
							  }
						  }),createCheckBox('显示直接下级数据',false,'statisticLower','statisticLower',0,50,3,function(obj,ischecked){
							  if(ischecked){
								  Ext.getCmp('statisticMe').setValue(false);
//								  Ext.getCmp('statisticLowerAll').setValue(false);
								  Ext.getCmp('statisticAll').setValue(false);
				...
				createFieldset('statisticResult','statisticResult',355,0,'统计数据显示',
