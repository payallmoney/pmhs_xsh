...
//			console.log(tmpStatisticType);
			...
			if(healthfile){
				...
				colsVisibleFalse.push(getColumnsIndexDetail(this.idsArray.grid,'healthCount'));
				...
				colsVisibleTrue.push(getColumnsIndexDetail(this.idsArray.grid,'healthCount'));
...
//						  createCheckBox('健康体检数据',false,this.idsArray.medicalexam,this.idsArray.medicalexam,110,50,3,null)
						  ],210)]
			}]
		});
