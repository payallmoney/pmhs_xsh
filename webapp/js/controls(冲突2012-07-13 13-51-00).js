...
//                    combo.reset();
        ...
        function NewList(c, cfg, fieldName){
            ...
            var disabledCss = setting.disable ? "display:none;" : "";
            c.html("<div class='list' id='" + fieldName  + "' style='" + disabledCss + "'>" + spans + newLine +  "<input class='list-input' type='text' size='1'></div>");
            var ele = $("div", c);
