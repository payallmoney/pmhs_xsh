...
Ext.sms.MsgSender = new Ext.Panel({
    ...
    items : [  {
            ...
            tbar : [ '类型：', {
                ...
                xtype : 'combo',
                id : 'sms.query.combo.examname',
                store : new Ext.data.SimpleStore({
                    fields : [ 'type', 'display' ],
                    data : [ ['','全部'], ['15段婚检宣传','15段婚检宣传'],
                             ['18月龄甲肝减毒活疫苗','18月龄甲肝减毒活疫苗'],
                             ['18月龄麻腮风疫苗','18月龄麻腮风疫苗'],
                             ['1月龄第2剂乙肝疫苗','1月龄第2剂乙肝疫苗'],
                             ['2~5次产检下次产检前3天提醒','2~5次产检下次产检前3天提醒'],
                             ['20月龄百日破','20月龄百日破'],
                             ['2岁龄乙脑减毒活疫苗','2岁龄乙脑减毒活疫苗'],
                             ['2月龄脊灰疫苗','2月龄脊灰疫苗'],
                             ['3岁A+C流脑疫苗','3岁A+C流脑疫苗'],
                             ['3月龄百日破','3月龄百日破'],
                             ['3月龄脊灰疫苗','3月龄脊灰疫苗'],
                             ...
                             ['6月龄乙肝疫苗','6月龄乙肝疫苗'],
                             ['8月龄麻风疫苗','8月龄麻风疫苗'],
                             ['8月龄乙脑减毒活疫苗','8月龄乙脑减毒活疫苗'],
                             ['9月龄A群流脑疫苗','9月龄A群流脑疫苗'],
                             ['儿童出生次日防诈骗提醒','儿童出生次日防诈骗提醒'],
                             ['儿童生日10个月体检','儿童生日10个月体检'],
                             ['儿童生日1岁半体检','儿童生日1岁半体检'],
                             ['儿童生日1岁体检','儿童生日1岁体检'],
                             ['儿童生日2个月体检','儿童生日2个月体检'],
                             ['儿童生日2岁半体检','儿童生日2岁半体检'],
                             ...
                             ['儿童生日8个月体检','儿童生日8个月体检'],
                             ['非15段婚检宣传','非15段婚检宣传'],
                             ['分娩产后42天访视提醒','分娩产后42天访视提醒'],
                             ['分娩产后访视提醒','分娩产后访视提醒'],
                             ['公共场所复核','公共场所复核'],
                             ['公共场所延续','公共场所延续'],
                             ['施甸县妇幼专干测试','施甸县妇幼专干测试'],
                             ['施甸县管理人员婚检宣传20130805','施甸县管理人员婚检宣传20130805'],
                             ['首次产检后1天提醒','首次产检后1天提醒'],
                             ['首次产检预产期5天前提醒','首次产检预产期5天前提醒'],
                             ['新生儿减免防诈骗新生儿减免防诈骗','新生儿减免防诈骗新生儿减免防诈骗'],
                             ['医疗机构校验','医疗机构校验'] ]
                }),
                displayField : 'display',
                valueField : 'type',
                ...
                proxy : new Ext.ux.data.DWRProxy({
                    ...
                    listeners : {
                        'beforeload' : function(dataProxy, params) {
                            ...
                            if(!Ext.isEmpty(Ext.getCmp("sms.query.combo.examname").getValue())){
                                cond.conditions[cond.conditions.length] = {filterKey:"vo.examname",filterVal:Ext.getCmp("sms.query.combo.examname").getValue(),opt:"="};
                            }
                            var o = cond;
                            if (!params.limit)
                                params.limit = 20;
