...
//        $(toolbar).prependTo($('.testToolbar'));
        ...
        $.each(cfg, function (_, v) {
            ...
            if (cc['isComposite'] && cc.isComposite) {
                ...
                if (childCodes) {
                    rawCodes = rawCodes.concat(childCodes);
                }
            }
...
//        }
                            ...
                            if (data.length > 0) {
                                ...
                                if (infos != null && infos != '') {
                                    ...
                                    if ($.isFunction(services.aftersave)) {
                                        ...
                                        services.aftersave(personId, send.historyselect, {
                                            callback: function (data) {
        ...
        function go() {
            ...
            $.each(cfg, function (_, v) {
                var idname = '';
                if ($("#" + v.id).length > 0 && $("#" + v.id).get(0).tagName == 'TD') {
                    idname = $("#" + v.id).prev().text();
                } else {
