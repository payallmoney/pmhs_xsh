 ...
 */
//Ext.tf.SimplePanel = function(){
	
  
//	Ext.tf.SimplePanel.superclass.constructor.call(this);
//};
Ext.tf.SimplePanel = Ext.extend(Ext.Panel, {
  ...
  initComponent : function() {
    ...
    this.grid = new Ext.tf.SimpleGridPanel({
      ...
      store: this.store,enableColumnResize:false,enableColumnMove:false,
