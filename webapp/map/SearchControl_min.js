...
(function () {
    ...
    SearchControl.prototype = {
                        ...
                        '<div id="BMapLib_sc0">',
                            '<table style="width:100%;" border="0" cellpadding="0" cellspacing="0">',
                                '<tr>',
                                    ...
                                    '</td>',
                                    '<td>',
                                        '<div class="BMapLib_sc_t_b sc_btn" id="BMapLib_sc_b0">搜索</div>',
                                    '</td>',
                                '</tr>',
                            '</table>',
                        '</div>',
        ...
        , _initCityTab : function () {
            ...
            citySelectDom.style.cssText = "position:absolute;top:0px;left:0px;width:80%;background:#FAFAFA;left:10%;overflow:hidden;top:5%;border:1px solid #8C8C8C;display:none;";
