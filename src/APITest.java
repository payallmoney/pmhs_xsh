...
public class APITest {
	// 沙箱环境调用地址
	// API地址URL	
	protected static String testUrl = "http://124.133.239.162:9898/api/baseinfo/list_baseinfo";
	// 签名所需key()
	protected static String key ="476035743664029266825384875995117369268221954084662752473736190551067918373765337720654151";	
	protected static String data="{'createdDateEnd':'2014-06-16 00:00:00','createdDateStart':'2014-06-16 00:00:00','doctor':'佟医生'}";
	// // 报文响应格式
	 protected static String format = "json";
	 // 合作方ID
	 protected static String merId = "100036";
	 // 加密模式
	 protected static String dataMode = "0";
	 // 操作员ID
	 protected static String openId = "ph003300";
	...
	public static String testUserGet() {
		...
		System.out.println("============"+data + merId + dataMode + key);
	...
	public static void main(String[] args) {
		...
		String paramStr = testUserGet();
		String result = URLUtil.getResult(testUrl, paramStr);
