...
/**
 * Icd10 generated by hbm2java
 */
public class Icd10 implements java.io.Serializable {
	...
	public Icd10(Integer id, Integer parentId, Integer level, Integer isDetail) {
		this.id = id;
	...
	public Icd10(Integer id, String name, String number, String structNumber,
