...
/**
 * TaskCode entity. @author MyEclipse Persistence Tools
 */

public class TaskCode implements java.io.Serializable {
	...
	/** minimal constructor */
	public TaskCode(String id, String tablename, String col, Integer days,
			Timestamp optdate, String msg, String wherestr) {
		this.id = id;
	...
	/** full constructor */
	public TaskCode(String id, String name, String tablename, String col,
