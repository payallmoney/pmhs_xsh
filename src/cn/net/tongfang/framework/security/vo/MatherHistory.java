...
/**
 * MatherHistory generated by hbm2java
 */
public class MatherHistory implements java.io.Serializable {

	private String id;
	private String personalInfoId;
	private Integer heredityId;

	public MatherHistory() {
	}

	public MatherHistory(String personalInfoId, Integer heredityId) {
