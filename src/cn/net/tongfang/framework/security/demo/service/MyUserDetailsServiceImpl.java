...
//		return new User(username, password,enabled,true, true, true, combinedAuthorities);
		return new TaxempDetail(operatorBo.getId(), operatorBo.getUsername(), operatorBo.getPassword(), operatorBo.getDistrict(), 
				operatorBo.getOrg(), operatorBo.getOrgId(), operatorBo.getDistrictId(), enabled, combinedAuthorities,operatorBo.
				getIsLookAuthority(),operatorBo.getIsChangeCertifiAuthority(),operatorBo.getIsSupplyCertifiAuthority(),
				operatorBo.getIsAdvancedCertifiAuthority(),operatorBo.getIsOver2MonthCertifiAuthority());
	}
